...
class WordsFinder: # Инициализация класса
    def __init__(self, *file_names):
        self.file_names = file_names # Метод для получения всех слов из файлов
    ...
    def get_all_words(self):
        ...
        return all_words  # Метод для поиска слова в файлах
    ...
    def find(self, word):
        ...
        return result # Метод для подсчета количества вхождений слова в файлах
    ...
    def count(self, word):
        ...
        return result  # Создание экземпляра объекта
